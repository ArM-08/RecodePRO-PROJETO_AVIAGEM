<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="modelo.Permissoes" import="java.util.List"%>

<%
@SuppressWarnings("unchecked")
	List<Permissoes> lista = (List<Permissoes>) request.getAttribute("permissao");
%>
...
<body>
	...
	<header class="container my-4">
		<div class="row">
			<div class="col">
				<a class="btn btn-info" href="./view/permissoes/cadastrar.html">Cadastrar Permissao</a>
	...
	<table class="table container">
		<thead class="thead-dark">
			<tr>
				<th scope="col">#</th>
				<th scope="col">ID Permissao</th>
				<th scope="col">tipo de Permissaor</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a class="btn btn-success" href="editar-destino?id=<%=a.getId()%>">Atualizar Destino</a>
					<a class= "btn btn-danger" href="deletar-destino?id=<%=a.getId()%>">Deletar Destino</a>
				</td>
